    ...
    <header id="header">
        <nav class="flex-container nav-bar">
            ...
            <ul class="menu flex-container">
                <li class="menu-item"><a href="..\pages\index.php" class="font-18 san-serif dark-grey">Home</a></li>
                <li class="menu-item"><a href="..\pages\dauto.php" class="font-18 san-serif dark-grey">D Auto</a></li>
